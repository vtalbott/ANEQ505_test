...
################################################################################
# Research Questions
1. Does microbial community diversity change over accumulated degree days?
2. Does facility influence microbial diversity?
...
sampletype_bray_curtis <- ggplot(metadata_bc, aes(x = PC1, y = PC2, color = sample_type)) + 
  ...
  scale_color_manual(
    values = c("skin" = "salmon", "soil" = "skyblue"),
    name = "Sample Type"
  ) +
